            ...
            <ul class="navbar-nav w-100"> <!-- Utilisation de w-100 pour étendre la barre de navigation sur toute la largeur -->
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item ms-auto"> <!-- Utilisation de ms-auto pour pousser l'élément vers la droite -->
                    <a class="nav-link" href="index.php?controller=communication&action=apropos">LISTE D'INSCRITS</a>
                </li>
                <li class="nav-item "> 
                    <a class="nav-link" href="index.php?controller=auth&action=login"><i class="bi bi-person-circle "> CONNEXION</i></a>
                </li>
            </ul>
        </div>
    </div>
